...
const Data = () => {
  return (
    <div className='home__data'>
      ...
      <p className='home__description'>Programador criativo e dedicado. Residente na cidade de Recife, PE. Tenho paixão pela programação e muito comprometimento com a excelência no meu trabalho. Cada projeto é uma oportunidade para eu explorar novas ideias e desafiar os limites do que é possível. Estou sempre buscando maneiras de aprimorar minhas habilidades e contribuir para o campo da tecnologia. </p>

      <a href="#contact" className='button  btn--home button--flex'>
         Dê um alô!
         <svg
